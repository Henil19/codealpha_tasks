...
# Cell 1: Install required libraries (safe pinned set)
# Removes googletrans (source of conflicts), installs deep-translator and gTTS
...
# Cell 5: Set Azure credentials for this Colab session

import os
# ===== EDIT THESE LINES (your Azure Translator key & region) =====
# Example region values: "eastus", "westeurope", "centralus", etc.
os.environ["AZURE_KEY"] = "3uiWQypPH4GkKR8zOEqvDLJ5BwLKTri72Vvu31KhcsqdCUbAoEXtJQQJ99BKACqBBLyXJ3w3AAAbACOGYh7m"
os.environ["AZURE_REGION"] = "southeastasia"
# ================================================================
print("AZURE_KEY set?", bool(os.environ.get("AZURE_KEY")))
print("AZURE_REGION set?", bool(os.environ.get("AZURE_REGION")))

# Cell 6: Register Python callbacks callable from JS
...
# Cell 7: Inject the HTML UI that tries Azure first and falls back automatically
...
# Safe programmatic test (direct Python calls)
